...
public class Ports {
		...
		public static class Analog{
			...
			public static final int REAR_LEFT_TURNING_ABSOLUTE_ENCODER = 1;
			public static final int FRONT_RIGHT_TURNING_ABSOLUTE_ENCODER = 4;
		...
		public static class CAN{
			...
			public static final int FRONT_RIGHT_DRIVING = 11;
		...
		public static class USB{
			...
			public static final int co_pad = 1;
		}
