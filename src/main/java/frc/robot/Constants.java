...
public final class Constants {
	public static final class Swerve{
		...
		public static final Translation2d flModuleOffset = new Translation2d(WHEEL_BASE_METERS / 2, TRACK_WIDTH_METERS / 2);
		public static final Translation2d frModuleOffset = new Translation2d(WHEEL_BASE_METERS / 2, TRACK_WIDTH_METERS / 2);
		public static final Translation2d blModuleOffset = new Translation2d(WHEEL_BASE_METERS / 2, TRACK_WIDTH_METERS / 2);
		public static final Translation2d brModuleOffset = new Translation2d(WHEEL_BASE_METERS / 2, TRACK_WIDTH_METERS / 2);
	...
	public static final class DrivetrainConstants {
		...
		public static final double MAX_SPEED_METERS_PER_SECOND = 3; //4.42; //4.8;
		public static final double MAX_ANGULAR_SPEED_RADIANS_PER_SECOND = 1.5 * Math.PI; // radians per second
	...
	public static final class SwerveModuleConstants {
		...
		public static final double DRIVING_P = 0.01;
		...
		public static final double TURNING_P = 0.7; //1.0; // 1.0 might be a bit too much - reduce a bit if needed
